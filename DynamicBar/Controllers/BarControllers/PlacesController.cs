...
namespace DynamicBar.Controllers.BarControllers
{
    public class PlacesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PlaceId,Title,DateCreated,Capacity,CreatedById")] Place place)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PlaceId,Title,DateCreated,Capacity,CreatedById")] Place place)
        {
            if (ModelState.IsValid)
            {
